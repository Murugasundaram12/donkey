...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row">
                <h2 class="mb-2 page-title">Riders List</h2>

                <div class="col ml-auto">
                    <div class="dropdown float-right">
                        @can('driver-create')
                        <a href="{{ url('driver/create') }}"><button class="btn btn-primary float-right ml-3"
...
<td><span class="badge badge-pill badge-danger">Offline</span></td>                                            
                                        ...
                                        <td>
                                            ...
                                            <div class="check-box text-left">
                                                <input type="checkbox" data-id="{{ $driver->id }}" name="status"
                                                class="js-switchs" {{ $driver->status == 1 ? 'checked' : '' }} style="font-size:small;">
                                            </div>
                                            @endif
                                        </td>
                                        @endcan
                                        ...
                                        <td>
                                            <a href="{{ url('driver/show/'.$driver->id)}}"><span
                                                    class="fe fe-24 fe-eye text-warning"></span></a>
                                                    @can('driver-edit')
                                                    <a href="{{ url('driver/'.$driver->id)}}"><span
                                    ...
                                    <div class="modal fade" id="verticalModal{{ $driver->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="{{url('driverblock/'.$driver->id)}}">
                                                    {{csrf_field()}}
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">Driver
                                                                Name:</label>
    ...
    <div class="modal fade" id="update-form" tabindex="-1" role="dialog" aria-labelledby="verticalModalTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form class="needs-validation" method="post" action="{{url('driverunblock')}}"
...
<script>
    $('#dataTable-1').on("click",".update_user",function(){
