                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" method="post" action="{{ url('driverstore') }}"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="subscriber"
                                                class="form-control select2 @error('subscriber') is-invalid @enderror"
                                                id="subscriber" search="true" value="">
                                                <option value="">Select Subscriber</option>
                                                @foreach ($subscriber as $subscriber)
                                                    <option value="{{ $subscriber->id }}"
                                                        {{ (is_array(old('subscriber')) and in_array($subscriber->id, old('subscriber'))) ? ' selected' : '' }}>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                accept=".pdf" name="aadharFrontImage" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                value="{{ old('rcbook') }}" accept=".pdf" name="rcbook" required>
                                            <small id="rcbook" class="form-text text-muted">Note:Please Upload PDF
                                                Format
                                                </span></small>
                                            @error('rcbook')
                                                <span class="invalid-feedback">
                                        ...
                                        <!-- <div class="col-md-6 mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                id="insurance" value="{{ old('bankstatement') }}" accept=".pdf"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <small id="bike" class="form-text text-muted">Note:Please Upload PDF
                                                Format
                                                </span></small>
                                            @error('bike')
                                                <span class="invalid-feedback">
