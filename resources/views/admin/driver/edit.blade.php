                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control @error('dob') is-invalid @enderror"
                                                id="dob" value="{{ old('dob', $dob) }}" name="dob">
                                            @error('dob')
                                                <span class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description">{{ $driver->description, old('description') }}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
