...
@section('content')
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
                <div class="row">
              <h2 class="mb-2 page-title">Rider Blocked List ( By Admin )</h2>

                <div class="col ml-auto">
                    <div class="dropdown float-right">
                        <a href="{{ route('drivers') }}"><button class="btn btn-dark float-right ml-3" type="button"><i class="fe fe-arrow-left-circle"></i>  Driver</button></a>
                      ...
                      <table class="table datatables" id="dataTable-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{  App\Models\Admin::where('id', $driver->blockedBy)->first()?->emp_id}}</td>
                            <td>{{$driver->comments}}</td>

                            <td>{{$driver->created_at->format('d-m-Y h:i:s')}}</td>
                            <td> @if ($driver->driverstatus == 2)
                                <p class="badge badge-danger">Blocked</p>
                                @elseif ($driver->driverstatus == 1)
