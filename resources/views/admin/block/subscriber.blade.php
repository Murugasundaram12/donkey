...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row">
                <h2 class="mb-2 page-title">Subscriber Block List</h2>
                ...
                <div class="col ml-auto">
                    <div class="dropdown float-right">
                        ...
                        <a href="{{ url('subscriberList') }}"><button class="btn btn-dark float-right ml-3" type="button"><i class="fe fe-arrow-left-circle"></i> Subscriber</button></a>
                    </div>
                </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatables" id="dataTable-1">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    @foreach ($blocklist as $subscriber)
                                    <tr>                                        
                                        <td>{{ $i }}</td>
                                        <td>{{ $subscriber->subscribername }}</td>
                                        <td>{{ $subscriber->subscriberId }}</td>
                                        <td>{{ App\Models\Admin::where('id',$subscriber->blockedBy)->first()?->emp_id }}
                                        </td>
                                        ...
                                        @endphp
                                            @if ($subscriberCopy->blockedstatus == 0)
