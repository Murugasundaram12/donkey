            ...
            <div class="col-12">
              ...
              <div class="col ml-auto">
                <div class="dropdown float-right">
                  <a href="{{ url('coupons/create') }}"><button class="btn btn-primary float-right ml-3" type="button">Add more +</button></a>
...
<a href="{{ url('coupons/'.$coupons->id)}}"><span class="fe fe-24 fe-edit text-success"></span></a>
<a href="{{ url('couponsdelete/'.$coupons->id)}}" class="button delete-confirm"><span class="fe fe-24 fe-trash text-danger"></span></a>
