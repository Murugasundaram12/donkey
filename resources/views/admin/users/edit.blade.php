    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('emp_id', null, ['placeholder' => 'Enter Like Employee Id - ####', 'class' => 'form-control']) !!}
            </div>
        </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('education', null, ['placeholder' => 'Eucational Qualification', 'class' => 'form-control']) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('gender', ['Male' => 'Male', 'Female' => 'Female', 'Others' => 'Others'], 'Male', [
                    'class' => 'form-control',
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                ...
                {!! Form::text('official_mobile', null, ['placeholder' => 'Official Mobil', 'class' => 'form-control']) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('payment', ['Half Roll' => 'Half Roll', 'On Roll' => 'On Roll'], 'Half Roll', [
                    'class' => 'form-control',
                ]) !!}
            </div>
        </div>
