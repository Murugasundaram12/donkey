            ...
            <div class="col-md-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="needs-validation" method="post" action="{{route('enquiry.store')}}" enctype="multipart/form-data"  novalidate>
                    {{csrf_field()}}
                    <div class="form-row">
                      ...
                      <div class="col-md-6 mb-3">
                        <label for="ficon">Piriority </label>
                    ...
                    @enderror
                       ...
                       <div class="col-md-6 mb-3">
                        ...
                        <select name="category" class="form-control @error('category') is-invalid @enderror" id="category"  >
                            ...
                            <option value="driver" {{ (old('category') ) ? ' selected' : '' }}>Driver</option>
