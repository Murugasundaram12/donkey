                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        ...
                                                        <button type="button" class="btn mb-2 btn-outline-danger"
                                                            data-toggle="modal"
                                                            data-target="#verticalModal{{ $subscriber->id }}">Block</button>
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @can('subscriber-delete')
                                                        ...
                                                        <a href="{{ url('subscriberdelete/' . $subscriber->id)}}"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="message" id="" required
                                                                        ...
                                                                        <option value="Price Changes  Are Not Reasonable">Price
                                                                            C
                                                                            hanges Are Not Reasonable</option>
                                                                        <option
                                                                            value="Newly Uploaded Document Are No
                                                                                                                    t Matching">
                                                                            Newly Uploaded Document Are Not Matching</option>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="message" id="" required
                                                                        ...
                                                                        <option value="Price Changes Are Validated">Price Ch
                                                                            a nges Are Validated</option>
