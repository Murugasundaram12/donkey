                                ...
                                <div class="form-row">
                                   ...
                                   <div class="col-md-6 mb-3">
                                    ...
                                    <!--    <label for="qr">QR</label>
                                        <input type="file" class="form-control @error('qr') is-invalid @enderror"
                                            id="qr" value="{{ old('qr') }}" name="qr"
                                            accept="image/*">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label for="pickup_price">Pickup and drop Service Fare</label>
                                        <input type="text"
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="cab_price" name="cab_price"
                                            value="{{ $subscriber->cab_price, old('cab_price') }}" required>
                                        @error('cab_price')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                id="cab_price1" name="cab_price1"
                                                value="{{ $subscriber->cab_price1, old('cab_price1') }}" required>
                                            @error('cab_price1')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $subscriber->cab_price2, old('cab_price2') }}" required>
                                            @error('cab_price2')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $subscriber->cab_price3, old('cab_price3') }}" required>
                                            @error('cab_price3')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $subscriber->cab_price4, old('cab_price4') }}" required>
                                            @error('cab_price4')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                ...
                <div class="col-md-3">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            @if($subscriber->qr!="")
                            <strong class="card-title">QR</strong>
                            <div class="row">

                                <img src="{{ asset('qr/'.$subscriber->qr) }}" width="150px;"
                                    height="93px;" alt="{{ $subscriber->name }}" class="qr-img ">
