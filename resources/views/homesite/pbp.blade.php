...
<body class="js-scroll" id="scroll-container">
    ...
    <!-- Page Title -->
<div class="scroll">
    <section class="page-title bi picpic " style="background-image: url('public/assets/images/pbpp.jpeg'); margin-bottom:40px; ">
        <script>
        ...
        <div class="auto-container">
            <div class="content-box">
                <div class="content-wrapper">
                    <div class="title">
                        <h1 class="headdd abtus"> Prime Business Partner</h1>
                        <a href="#form-section"> <button class="btn custom-green-button sii"><B>SUBMIT INQUIRY</B></button></a>
                    </div>
    ...
    <section style="background-color: white;">
        <div style="padding-right: 15px;padding-left: 15px;  margin-right: auto; margin-left: auto;padding:30px">

            <div class="container">
                <h3 style="margin-top: 10px; margin-bottom: 40px;">
                    <b class="zoom-on-hover ing">By opening your business with<br> do N key service, you receive:</b>
                </h3>
                ...
                <div class="row" style="margin-bottom:50px;">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <img class="open_img ani" src="public/assets/images/building.gif	" width="70px" height="70px"
                            alt="">
                        <p class="para gra" style="color:#5C5C5C; font-size:14px;max-width:255px"><b>Exclusive rights to your
                                business area</b></p>
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <img class="open_img ani" src="public/assets/images/laptop.gif" alt="" width="70px;"
                            height="70px;">


                        <p class="para gra" style="color:#5C5C5C; font-size:14px;"><b>Automatic system for managing your
                                business</b></p>
                    </div>
                ...
                <div class="row" style="margin-bottom:50px;">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <img class="open_img ani mal" src="public/assets/images/responsive.gif" width="70px;" height="70px;"
                            alt="">
                        <p class="para gra mal" style="color:#5C5C5C; font-size:14px"> <b class="nene">Mobile apps for riders and users</b></p>

                    </div>
                    <div class="col-md-6 col-sm-12">

                        <img class="open_img ani" src="public/assets/images/rate.gif" width="70px;" height="70px;"
                            alt="">

                        <p class="para gra" style="color:#5C5C5C;font-size:14px"><b>Modern software for Prime Business Partner
                                & employees</b></p>
        ...
        <div class="row" style="padding-bottom: 81px;">
            <div class="col-12">
                <div class="custom-card gree" data-aos="fade-left">
                    <div class="card-content">
                        <b>
                            <p 
                                style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-weight:600px;">
                                You can manage your business from anywhere in the world, set your pricing policy yourself,
                                and control all financial indicators.</p>
                        </b>
                    </div>
                </div>
            </div>
    ...
    <section>
        <div style="padding:70px;background:#E8E9EB;">

            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="card kick" style="width: 90%;margin-left:140px;border-bottom: 6px solid #d3ff53">
                        <div class="card-body">
                            <div class="support__col-wrap">
                                <div class="support__item lin">Kick start your business with do N key</div>
                                <div class="support__item lin">The innovative Indian brand revolutionizing Bike taxi and
                                    delivery business</div>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <h1 class="support__title animated-text  fade-in-on-scroll buil"
                        style="font-weight:700; font-size:38px;margin-left:100px;margin-top:60px;color:#5C5C5C;">Building
                        Partnerships and Expanding Services</h1>

                </div>
                <script>
                    $(document).ready(function() {
                        const $animatedText = $('.fade-in-on-scroll');

                        $(window).scroll(function() {
                            const windowScroll = $(this).scrollTop();
                            const textPosition = $animatedText.offset().top - $(window).height();

                            if (windowScroll > textPosition) {
                                $animatedText.addClass('fade-in');
                            }
                        });
                    });
                </script>
...
<h1 class="support__title animated-text  fade-in-on-scroll buill"
    style="font-weight:700; font-size:38px;margin-left:138px;margin-top:60px;color:#5C5C5C;">Maintenance
    and Support</h1><p class="pa" style="color:#5C5C5C;margin-left:138px; font-size:18px;margin-top:40px;opacity: 0.54;">We assist our partners and support them on all stages of their work.</p>

</div>
                <div class="col-md-6 col-sm-12">
                    <div class="card ca" style="width: 90%;margin-left:70px;border-bottom: 6px solid #d3ff53">
                        <div class="card-body">
                            
                            <div class="support__col-wrap">
                                <div class="row">
                                <div class="col-6"> <div class="support__item any">Business Software Maintenance</div>
                                <div class="support__item any">Legal support</div>
                                <div class="support__item any">Call center services</div></div>
                                <div class="col-6 anyy"> <div class="support__item anyyy ">Provided marketing and design package</div>
                                <div class="support__item anyyy ">Employee training</div>
                                <div class="support__item anyyy">Technical support</div>
                                </div> <hr>
                              <b>  <p class="support__resume-text anyyyy">
                        All of this allows our partners to start their own business within the first month of partnership.                    </p></b></div>
    ...
    <section>
        <div style="padding-top:50px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <h2 style="margin-bottom: 25px;">Easy start</h2>

                        <img src="{{ url('public/assets/images/icons/easy.png') }}" class="es"
                            style="height: 25%; margin-top:10px; margin-bottom:10px;display:block; " alt="Left Image">
                        <br><br>
                        <div class="text">
                            <p class="hh" style="text-align: justify; width:100%;margin-right:10px;">Just one tap, and we'll help you
                                make your bike taxi and delivery business dream come true! No more wasting your time,
                                energy, and money to build a website & mobile app. By partnering with us, you'll feel
                                relieved and excited knowing that our solution is just one button away from turning your
                                dreams into a successful reality.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <h2 style="margin-left:103px; margin-bottom: 25px;"  class="wynts">What You Need to Start</h2>

                        <img src="{{ url('public/assets/images/icons/need.png') }}" class="es ess"
                            style="height: 25%;margin-top:10px; margin-bottom:10px; margin-left:98px;"
                            alt="Right Image"><br><br><br>
                        <div class="text " style="width: 80%; margin-left:auto">

                            <ul>

                                <li style="line-height:0.7" class="lili">Just fill the below enquiry <br><small>
                                <li></li>
                                <li style="color:red;margin-bottom:13px;"  class="lili">(Note - You are required to submit few documents)
                                </li></small></li>

                                <li style="line-height:0.7"  class="lili">We do background verification
                                    <br><small class="liliss">
                                <li style="color:red"  class="lili ">(Note - If the records are clear)</li>
                                </small></li> <br>
                                <li style="line-height:0"  class="lili">Sign a contract with <b> do N key Deliveries</b></li> <br>
                                <li style="line-height:1.5"  class="lili"> You can pay a pocket-friendly subscription fee on a monthly
                                    basis</li> <br>
                                <li style="line-height:0"  class="lili lilili">Receive exclusive rights to your subscription area</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section id="inquiry  ">
        ...
        <div style="width:100%;background:#E8E9EB;padding-bottom:60px" id="form-section">
            <div class="container mt-5">
                <h4 class="" style="font-weight: 600; color:#5C5C5C; font-style:bold; padding-top:50px;">Submit
                    Inquiry</h4><br>
                <div class="card rd" style="width:100%; border:none;">
                    <div class="card-body">
                        <div id="success-message" style="display: none;" class="alert alert-success">Successfully
                            Submitted!</div>

                        <form method="post" action="{{ route('inquirystore') }}" id="contact"
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 coll">
                                    ...
                                    <input type="text" class="form-control custom-hover it" value="{{ old('name') }}"
                                        name="name" id="name" required>
                                </div>
                                <div class="col-4 coll">
                                    <label for="email">Email<sup style="color:red;">*</sup></label>
                                    <input type="email" class="form-control custom-hover it" value="{{ old('mailId') }}"
                                        name="mailId" id="email" required>
                                </div>
                                <div class="col-4 coll">
                                    <label for="mobile">Mobile<sup style="color:red;">*</sup></label>
                                    <input type="text" class="form-control custom-hover it" value="{{ old('mobile') }}"
                                        name="mobile" id="email" required>
                                </div>

                                <div class="col-4 coll">
                                    <br>
                                    <label for="name">Area<sup style="color:red;">*</sup></label>
                                    <input type="text" class="form-control custom-hover it" value="{{ old('area') }}"
                                        name="area" id="name" required>
                                </div>
                                <br>
                                <div class="col-4 coll">
    <br>
    <label for="name">Pincode<sup style="color:red;">*</sup></label>
    <input type="text" class="form-control custom-hover it" value="{{ old('pincode') }}"
            ...
            if (this.value.length > 6) {
                this.value = this.value.slice(0, 6);
                               ...
                               {{-- <div class="col-4">
                                    ...
                                    <select class="form-control custom-hover" value="{{ old('pincode') }}" name="pincode"
                                        id="category">
                                ...
                                <div class="col-4 coll">
                                    ...
                                    <select class="form-control custom-hover it" value="{{ old('category') }}"
                                        name="category" id="category" required>
                                        <option value="Rider">Rider</option>
                                        <option value="Subscriber">Prime Business Partner</option>
                                    </select>
                                </div>
                                <div class="col-4 coll">
                                    <br>
                                    <label for="priority" class="pty ">Are you planning to join immediately?<sup class="sta" style="color:red;">*</sup></label>

                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="ficon" id="yes"
                                            value="{{ old('ficon', 1) }}">
                                        <label class="form-check-label" for="yes">Yes</label>
                                        <input style="margin-left: 20px;" type="radio" class="form-check-input nonn"
                                            name="ficon" id="no" value="{{ old('ficon', 0) }}">
                                        <label class="form-check-label nonnn " for="no"
                                            style="margin-left: 40px;">No</label>
                                    </div>

                                </div>
                                <div class="col-8">
                                    <br>
                                    <label for="message">Description<sup style="color:red;">*</sup></label>
                                    <textarea class="form-control custom-hover it" id="message" rows="4" value="{{ old('description') }}"
