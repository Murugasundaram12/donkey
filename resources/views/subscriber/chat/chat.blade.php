...
<script type="module">
     ...
     var name = "{{session::get('messagesubscriber')}}";
     ...
     onChildAdded(newmsg, (data) => {
          ...
          if (data.val().name == name) {
               ...
               $('#messagesection').append("<div class='row mt-3 '><div class='col-4 '><div >" + data.val().name + "</div></div><div class='col-8'></div></div><div class='row mt-3 '><div class='col-4 '><div class='left ml-5'>" + data.val().message + "</div></div><div class='col-8'></div></div>")
          }
