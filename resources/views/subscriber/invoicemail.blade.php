...
<html lang="en">
@php
    $paymentDetail = App\Models\PaymentDetails::with('subscriber')->latest()->first();
@endphp
...
<body>
    ...
    <div class="container">
        ...
        <div class="invoice-header  top-container">
            <img src="{{ url('public/site/' . $site->main_logo) }}" style="width: 50px;height:50px;" alt="Do N Key">
        </div>
        ...
        <div class="invoice-total">
            ...
            <a href="{{ route('invoicedownloadPDF', $paymentDetail->id) }}" class="download-button">Download
                Invoice</a>
