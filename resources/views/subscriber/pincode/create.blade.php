                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Enquiry Form</strong>
                            </div>
                            <div class="card-body">

                                <form class="needs-validation" method="post" action="{{route('subscribers.enquirystore')}}"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('area') is-invalid @enderror"
                                                id="area" value="{{ old('area') }}" name="area" required>
                                            @error('area')
                                                <span class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="email" class="form-control @error('mailId') is-invalid @enderror"
                                                id="mailId" name="mailId" value="{{ old('mailId') }}" required>
                                            @error('mailId')
                                                <span class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="alert alert-info p-2 mb-2" style="font-size: 0.95rem;" role="alert">
                                                <strong>Info:</strong> If your pincode is not listed, please send us a
                                                WhatsApp message.
                                                <a class="fw-bold text-decoration-none ms-1"
                                                    href="https://wa.me/919069067008" target="_blank"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="customRadio1" name="ficon" value="1"
                                                    class="custom-control-input  @error('ficon') is-invalid @enderror">
                                                <label class="custom-control-label" for="customRadio1">Yes</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="customRadio2" name="ficon" value="0"
                                                    class="custom-control-input  @error('ficon') is-invalid @enderror">
