            ...
            <div class="col-md-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="needs-validation" method="post" action="{{url('subscribers/couponsupdate/'.$coupons->id)}}" enctype="multipart/form-data"  novalidate>
                    {{csrf_field()}}
                    @method('PUT')
                    <div class="form-row">
                    ...
                    @enderror
                       ...
                       <div class="col-md-6 mb-3">
                        ...
                        <input type="file" class="form-control @error('couponimage') is-invalid @enderror" id="couponimage" value="{{ old('couponimage') }}"   name="couponimage"  >
                        @error('couponimage')
                        <span class="invalid-feedback" >
                            <strong>{{ $message }}</strong>
                        </span>
                    @enderror
                        <div class="invalid-feedback"> Please upload coupon image </div>
                        <img src="{{ asset('subscriber/coupons/image/'.$coupons->image) }}"  width="150px;" height="93px;" alt="{{ $coupons->name }}" class="avatar-img ">

                       </div>
                       <div class="col-md-6 mb-3">
                        <label for="xslfile">Xsl Sheet</label>
                        <input type="file" class="form-control @error('xslfile') is-invalid @enderror" id="xslfile" value="{{ old('xslfile') }}"   name="xslfile"  >
                        @error('xslfile')
                        <span class="invalid-feedback" >
                            <strong>{{ $message }}</strong>
                        </span>
                    @enderror
                        <div class="invalid-feedback"> Please upload xslfile</div>
                       </div>
                       <div class="col-md-6 mb-3">
