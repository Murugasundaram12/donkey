            ...
            <div class="col-md-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="needs-validation" method="post" action="{{url('subscribers/couponsstore')}}" enctype="multipart/form-data"  novalidate>
                    {{csrf_field()}}
                    <div class="form-row">
                    ...
                    @enderror
                       ...
                       <div class="col-md-6 mb-3">
                        ...
                        <input type="file" class="form-control @error('couponimage') is-invalid @enderror" id="couponimage" value="{{ old('couponimage') }}"   name="couponimage"  required>
                        @error('couponimage')
                        <span class="invalid-feedback" >
                            <strong>{{ $message }}</strong>
                        </span>
                    @enderror
                       ...
                       <div class="col-md-6 mb-3">
                        ...
                        <input type="file" class="form-control @error('xslfile') is-invalid @enderror" id="xslfile" value="{{ old('xslfile') }}"   name="xslfile"  required>
                        @error('xslfile')
                        <span class="invalid-feedback" >
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <input type="hidden" name="subscriberId" value="{{ session('subscribers')['id'] }}">
