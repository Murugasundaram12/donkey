            ...
            <div class="col-md-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="needs-validation" method="post" action="{{route('subscribers.enquirystore')}}" enctype="multipart/form-data"  novalidate>
                    {{csrf_field()}}
                    <div class="form-row">
                   ...
                   <div class="invalid-feedback"> Please check </div>
                    ...
                    @enderror
                       ...
                       <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="category" class="form-control @error('category') is-invalid @enderror" id="category" readonly value="driver" >
