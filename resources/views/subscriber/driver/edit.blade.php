                    ...
                    <div class="col-md-9">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Edit Driver --{{ $driver->name }} ({{ $driver->id }})</strong>
                            </div>
                            <div class="card-body">

                                <form class="needs-validation" method="post"
                                    action="{{ url('subscribers/driverupdate/' . $driver->id) }}"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $driver->location, old('location') }}" name="location">
                                            @error('location')
                                                <span class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="hidden" class="form-control  " id="oldpassword" name="oldpassword"
                                                value="{{ $driver->source }}">
                                            <input type="password"
                                                class="form-control @error('password') is-invalid @enderror " id="password"
                                                name="password" value="{{ old('password', $driver->source) }}" required
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control @error('dob') is-invalid @enderror"
                                                id="dob" value="{{ $user[0]->dob }}" name="dob">
                                            @error('dob')
                                                <span class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                                >{{ $driver->description, old('description') }}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                      ...
                                      <!--  <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ $driver->licenceexpiry, old('licenceexpiry') }}">
                                            @error('licenceexpiry')
                                                <span class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
