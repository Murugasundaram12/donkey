                ...
                <div class="row">
                    ...
                    <div class="col ml-auto">
                        <div class="dropdown float-right">
                            <a href="{{ url('subscribers/createDriver') }}"><button class="btn btn-success float-right ml-3"
                                    type="button">Create Driver</button></a>
                                        ...
                                        @foreach ($driver as $driver)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{-- <a href="{{ url('subscribers/driverdelete/'.$driver->id)}}"
